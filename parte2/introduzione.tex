...
ci avverte che correlazione non è causalità\sidenote{Per esempio, se i lavoratori $L$ di un'azienda sono proporzionali al fatturato
$F$ tramite una costante di proporzionalità $k$, allora $L = kF$, $L - kF = 0$ e $F = L/k$ sono tutte corrette, non abbiamo informazioni
su quale sia il driver, se il fatturato o il numero di lavoratori.}
